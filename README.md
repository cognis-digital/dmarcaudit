...
[![PyPI](https://img.shields.io/pypi/v/cognis-dmarcaudit.svg)](https://pypi.org/project/cognis-dmarcaudit/)
[![CI](https://github.com/cognis-digital/dmarcaudit/actions/workflows/ci.yml/badge.svg)](https://github.com/cognis-digital/dmarcaudit/actions)
...
DMARCAUDIT exists for one job — grade spf/dkim/dmarc posture & spoofability from dns records — and does it without a SaaS bill or heavyweight setup.
...
```bash
dmarcaudit --version
dmarcaudit scan .                      # scan the current project
dmarcaudit scan . --format json
dmarcaudit scan . --fail-on high       # non-zero exit for CI gates
dmarcaudit mcp                         # expose as an MCP server (Cognis.Studio / Claude Desktop / Cursor)
```
...
`dmarcaudit` is one of the **100+ tools** in the [Cognis Neural Suite](https://github.com/cognis-digital).
