"""DMARCAUDIT core — Grade SPF/DKIM/DMARC posture & spoofability from DNS records."""
...
RULES = [
    ("DMA-001", "high", "TODO", "Unresolved TODO / placeholder left in input", "Resolve before shipping."),
    ("DMA-002", "medium", "FIXME", "FIXME marker found", "Address the flagged issue."),
    ("DMA-003", "low", "XXX", "XXX marker found", "Review the flagged section."),
]
