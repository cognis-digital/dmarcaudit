"""Native cognis-connect emit for dmarcaudit — forward findings to any platform.

Maps dmarcaudit's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    dmarcaudit ... --format json | dmarcaudit-emit --to stix
    dmarcaudit-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
