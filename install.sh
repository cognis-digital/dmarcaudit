#!/usr/bin/env sh
# Universal installer for dmarcaudit. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/dmarcaudit.git"
echo "Installing dmarcaudit ..."
